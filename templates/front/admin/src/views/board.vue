		...
		<div :style='{"padding":"0 20px","flex":"auto","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"0","zIndex":"2"}'>
			<div :style='{"width":"25%","padding":"15px","flexDirection":"column","background":"url(http://codegen.caihongy.cn/20250106/7db27eb0e39349b8b771cf620e80d883.png) no-repeat center / 100% 100%","display":"flex","gap":"10px"}'>
				<div class="echarts1">
					...
					<div :style='{"width":"100%","flex":"auto","height":"0"}'>
						<div id="techanChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="techanChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
				...
				<div :style='{"alignContent":"center","padding":"0 0 20px 0","margin":"0","color":"#fff","alignItems":"center","background":"none","display":"flex","gap":"12px","width":"100%","fontSize":"14px","justifyContent":"space-evenly","height":"100px"}'>
					...
					<div :style='{"padding":"0","margin":"0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250107/1f7eba19214f45b0927b3bd789f47556.png) no-repeat center / 100% 100%","flexDirection":"row","flex":"1 1 auto","display":"flex","width":"190px","position":"relative","justifyContent":"space-evenly","height":"78px","maxWidth":"240px"}'>
						...
						<div :style='{"padding":"0","alignItems":"center","flexWrap":"wrap","flexDirection":"row","flex":"auto","display":"flex","width":"0","height":"auto"}'>
							<div :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"inherit","width":"100%","lineHeight":"24px","fontSize":"inherit","position":"relative","textOverflow":"ellipsis","height":"24px"}'>特产总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"18px","color":"rgb(52, 171, 255)","fontWeight":"bold","order":"20"}'>{{techanCount}}</div>
						</div>
					</div>

					<div :style='{"padding":"0","margin":"0","alignItems":"center","background":"url(http://codegen.caihongy.cn/20250107/1f7eba19214f45b0927b3bd789f47556.png) no-repeat center / 100% 100%","flexDirection":"row","flex":"1 1 auto","display":"flex","width":"190px","position":"relative","justifyContent":"space-evenly","height":"78px","maxWidth":"240px"}'>
						<div :style='{"width":"43px","margin":"0 10px","background":"url(http://codegen.caihongy.cn/20250107/45d8495090e54087a404215e9f585208.png) no-repeat ","flex":"none","display":"block","height":"43px"}'></div>
						<div :style='{"padding":"0","alignItems":"center","flexWrap":"wrap","flexDirection":"row","flex":"auto","display":"flex","width":"0","height":"auto"}'>
							<div :style='{"whiteSpace":"nowrap","overflow":"hidden","color":"inherit","width":"100%","lineHeight":"24px","fontSize":"inherit","position":"relative","textOverflow":"ellipsis","height":"24px"}'>新疆特产总数</div>
							<div :style='{"lineHeight":"24px","fontSize":"18px","color":"rgb(255, 156, 12)","fontWeight":"bold","order":"20"}'>{{xinjiangtechanCount}}</div>
						</div>
					</div>
				</div>
				<div class="echarts5">
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="techanChart5" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts6">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
					...
					<el-table id="xinjiangtechanTable" :data="xinjiangtechanList" border :stripe="true" :style='{"padding":"0","borderColor":"rgba(92,135,230,.3)","borderWidth":"0","background":"none","width":"100%","overflow-y":"scroll","borderStyle":"solid","height":"calc(100% - 36px)"}'>
						...
						<el-table-column :resizable="true" :sortable="false" prop="procity" label="地点">
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="shopname" label="商家名称">
						</el-table-column>
			...
			<div :style='{"padding":"15px","flexWrap":"wrap","flexDirection":"column","background":"url(http://codegen.caihongy.cn/20250106/7db27eb0e39349b8b771cf620e80d883.png) no-repeat center / 100% 100%","display":"flex","gap":"10px","width":"25%"}'>
				<div class="echarts3">
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="techanChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"padding":"0 0 0 30px","margin":"0","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250107/3565ea449bfe47fe97db61984b2d1b0a.png) no-repeat left center","flex":"none","width":"100%","height":"auto"}'>
					...
					<div :style='{"width":"100%","padding":"0","flex":"auto","height":"0"}'>
						<div id="techanChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
	...
	export default {
		data() {
			return {
				...
				myChart0: null,
				xinjiangtechanList: [],
				xinjiangtechanTimer: null,
				systemIntroductionDetail: null,
				dates: '',
				techanCount: 0,
				xinjiangtechanCount: 0,
		...
		created() {
			this.$nextTick(()=>{
				...
				setTimeout(()=>{
					...
					this.techanChat4();
					this.techanChat5();
					this.getxinjiangtechanCount();
				},500)
			})
		},
		methods:{
			getxinjiangtechanList() {
				let params = {
					page: 1,
					limit: 20,
				}
				this.$http({
					url: "xinjiangtechan/page",
					method: "get",
					params: params
				}).then(({ data }) => {
					if (data && data.code === 0) {
						this.xinjiangtechanList = data.data.list;
						let div = document.getElementById('xinjiangtechanTable')
						var scrollTop = -1
						function move() {
							if (div){
						...
						this.xinjiangtechanTimer = setInterval(move, 2000);
						div.addEventListener('mouseenter', e => {
							e.stopPropagation()
							clearInterval(this.xinjiangtechanTimer);
						})
			...
			techanChat1() {
				this.$nextTick(()=>{
					...
					var techanChart1 = echarts.init(document.getElementById("techanChart1"),'macarons');
					this.$http({
						url: `techan/value/shangpinmingcheng/discussnum`,
						method: "get",
						params: {
							order: 'desc'
						}
			...
			techanChat2() {
				this.$nextTick(()=>{
					...
					var techanChart2 = echarts.init(document.getElementById("techanChart2"),'macarons');
					this.$http({
						url: `techan/value/shangpinmingcheng/storeupnum`,
						method: "get",
						params: {
							order: 'desc'
						}
			...
			techanChat3() {
				this.$nextTick(()=>{
					...
					var techanChart3 = echarts.init(document.getElementById("techanChart3"),'macarons');
					this.$http({
						url: `techan/value/shangpinmingcheng/clicknum`,
						method: "get",
						params: {
							order: 'desc'
						}
			...
			techanChat4() {
				this.$nextTick(()=>{
					...
					var techanChart4 = echarts.init(document.getElementById("techanChart4"),'macarons');
					this.$http({
						url: `techan/value/shangpinmingcheng/thumbsupnum`,
						method: "get",
						params: {
							order: 'desc'
						}
			...
			techanChat5() {
				this.$nextTick(()=>{
					...
					var techanChart5 = echarts.init(document.getElementById("techanChart5"),'macarons');
					this.$http({
						url: `techan/value/shangpinmingcheng/crazilynum`,
						method: "get",
						params: {
							order: 'desc'
						}
			...
			getxinjiangtechanCount() {
				this.$http({
					url: `xinjiangtechan/count`,
					method: "get"
				}).then(({
					data
				}) => {
					if (data && data.code == 0) {
						this.xinjiangtechanCount = data.data
					}
				})
			},
		}
