		...
		methods: {
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					this.ruleForm.onelimittimes = Number('5'); 					this.ruleForm.alllimittimes = Number('500'); 				}
				// 获取用户信息
				this.$http({
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../django9062th44/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
