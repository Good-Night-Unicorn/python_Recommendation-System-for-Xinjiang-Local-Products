	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="地点" prop="procity" >
					<el-input v-model="ruleForm.procity" placeholder="地点" clearable  :readonly="ro.procity"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="地点" prop="procity" >
					<el-input v-model="ruleForm.procity" placeholder="地点" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="销售量描述" prop="salestext" >
					<el-input v-model="ruleForm.salestext" placeholder="销售量描述" clearable  :readonly="ro.salestext"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="销售量描述" prop="salestext" >
					<el-input v-model="ruleForm.salestext" placeholder="销售量描述" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="食品工艺" prop="shipingy" >
					<el-input v-model="ruleForm.shipingy" placeholder="食品工艺" clearable  :readonly="ro.shipingy"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="食品工艺" prop="shipingy" >
					<el-input v-model="ruleForm.shipingy" placeholder="食品工艺" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="包装规格" prop="baozhuanggg" >
					<el-input v-model="ruleForm.baozhuanggg" placeholder="包装规格" clearable  :readonly="ro.baozhuanggg"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="包装规格" prop="baozhuanggg" >
					<el-input v-model="ruleForm.baozhuanggg" placeholder="包装规格" readonly></el-input>
				</el-form-item>
			</template>
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `xinjiangtechan/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.xinjiangtechanCrossAddOrUpdateFlag = false;
											this.parent.search();
