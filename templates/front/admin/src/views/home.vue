<template>
	<div class="home-content">
		...
		<div class="statis-box">
			<div id="statis1" class="statis1 animate__animated" v-if="isAuth('techan','首页总数')">
				<div class="left">
					<span class="icon iconfont icon-zhangjie8"></span>
				</div>
				<div class="right">
					<div class="num">{{techanCount}}</div>
					<div class="name">特产总数</div>
				</div>
			</div>
			<div id="statis2" class="statis2 animate__animated" v-if="isAuth('xinjiangtechan','首页总数')">
				<div class="left">
					<span class="icon iconfont icon-chujia3"></span>
				</div>
				<div class="right">
					<div class="num">{{xinjiangtechanCount}}</div>
					<div class="name">新疆特产总数</div>
				</div>
			</div>
		</div>
		<!-- statis -->
		...
		<!-- 5 -->
		<div class="type5">
			<div id="techanChart1" class="echarts1 animate__animated" v-if="isAuth('techan','首页统计')"></div>
			<div id="techanChart2" class="echarts2 animate__animated" v-if="isAuth('techan','首页统计')"></div>
			<div id="techanChart3" class="echarts3 animate__animated" v-if="isAuth('techan','首页统计')"></div>
			<div id="techanChart4" class="echarts4 animate__animated" v-if="isAuth('techan','首页统计')"></div>
			<div id="techanChart5" class="echarts5 animate__animated" v-if="isAuth('techan','首页统计')"></div>
		</div>
	</div>
</template>
<script>
	...
	methods:{
		handleScroll() {
			let arr = [
				...
				{id:'techanChart1',css:'animate__fadeInUp'},
				{id:'techanChart2',css:'animate__fadeInUp'},
				{id:'techanChart3',css:'animate__fadeInUp'},
				{id:'techanChart4',css:'animate__fadeInUp'},
				{id:'techanChart5',css:'animate__fadeInUp'},
			]
