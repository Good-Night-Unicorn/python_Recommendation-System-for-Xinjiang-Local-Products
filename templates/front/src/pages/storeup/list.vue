<template>
	<div :style='{"width":"100%","padding":"20px","margin":"10px auto","position":"relative","background":"none","maxWidth":"1200px"}'>
		...
		<div v-if="storeupType==1" class="section-title" :style='{"padding":"0 0 0 90px","margin":"0 0 20px 0","color":"#fff","textAlign":"left","background":"url(http://codegen.caihongy.cn/20250215/e708fb800ede46ebb777ef963256613d.png) no-repeat left center","width":"100%","letterSpacing":"2px","lineHeight":"70px","fontSize":"22px","fontWeight":"600"}'>我的收藏</div>
