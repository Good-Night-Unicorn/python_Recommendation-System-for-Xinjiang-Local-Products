...
def schemaName_spider(request, tableName):
    if request.method in ["POST", "GET"]:
        ...
        # Linux
        cmd = "cd /yykj/python/9999/spider4r5z8j23 && scrapy crawl "+tableName+"Spider -a databaseName=django9062th44"
        # Windows
        # cmd = "cd C:\\test1\\spider && scrapy crawl " + tableName + "Spider -a databaseName=django9062th44"
        os.system(cmd)
